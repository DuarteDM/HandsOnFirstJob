                  ...
                  Container(
                    child: Row(
                        ...
                        children: [
                          ...
                          Buttons(
                              icons: Icons.calendar_today, name: 'Nascimento'),
                        ]),
                  ),
                  Container(
                    child: Row(
              ...
              Column(children: [
                Container(
                  child: Row(
                      ...
                      children: [
                        Buttons(
                            icons: Icons.sports_handball, name: 'Saúde Física'),
                        Buttons(
                            icons: Icons.self_improvement,
                            name: 'Saúde Espiritual'), //psychology
                      ]),
                ),
              ]),
                  ...
                  child: Row(
                      ...
                      children: [
                        Buttons(
                            ...
                            name:
                                'Adicionar familiares'), //family_restroom, person_add_alt_1, supervised_user_circle
                      ]),
                ),
              ]),
                ...
                children: [
                  Container(
                    child: Row(
                        ...
                        children: [
                          Buttons(
                              icons: Icons.volunteer_activism_outlined,
                              name:
                                  'Necessidade'), //pan_tool_outlined, real_estate_agent_outlined
                          Buttons(
                              icons: Icons.outgoing_mail, name: 'Encaminhar'),
                        ]),
                  ),
                  Container(
                    child: Row(
                  ...
                  child: Row(
                      ...
                      children: [
                        Buttons(
                            ...
                            name: 'Adicionar Observação'), //note_alt
                      ]),
                ),
              ]),
              Column(children: [
